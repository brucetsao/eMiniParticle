...
#include "String.h"
// this session is used for Bluetooth to cinnect mobile phone with APP to show PM2.5

//SoftwareSerial mySeria2(2, 3); // RX, TX

void setup() {
  Serial.begin(9600);
  Serial.println("Program Start Here");
  Serial1.begin(9600); // Bluetooth UART has baud rate 9600
  Serial2.begin(9600);
   Serial.println("Bluetooth is Start") ;
...
//Serial.println("Enter PMsensor d for Reading") ;
  ...
  while (( Serial1.available()>0) && (count < pmsDataLen) )
  {
...
void SenArray2BT() 
{
    ...
    Serial.println("Now Send Data to Bluetooth")   ;
   //    Serial2.print("Hello");
