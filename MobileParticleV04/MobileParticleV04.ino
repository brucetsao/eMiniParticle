...
//------------for Nokia 5110
  ...
  Serial.println("Nokia 5110 init is ok");
  ...
  myHumidity.begin(); 
  Serial.println("Humidity Sensor is ok");
  initRTC();
  Serial.println("RTC Sensor is ok");
...
String  StrTime2() {
  ...
  ttt = StringTime3(nowT.hour(), nowT.minute(), nowT.second()) ;
...
String  StringTime3(int hhh, int mmm, int sss) {
  String ttt ;
  ttt = print2digits(hhh) + print2digits(mmm) + print2digits(sss) ;
  return ttt ;
}
